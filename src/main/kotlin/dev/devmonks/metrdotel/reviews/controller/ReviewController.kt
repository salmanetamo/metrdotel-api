...
class ReviewController @Autowired constructor(
    ...
    fun createReview(@RequestBody @Valid payload: ReviewRequest, @PathVariable restaurantId: String): ResponseEntity<*> {
    ...
    @PutMapping("/{id}")
    fun updateReview(@PathVariable id: String, @RequestBody @Valid payload: ReviewRequest): ResponseEntity<*> {
